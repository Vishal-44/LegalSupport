  ...
  return (
    <>
        <label htmlFor="file" className="labelFile"> 
            <span>
                <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" className="bi bi-cloud-upload" viewBox="0 0 16 16">
            ...
            <p>drag and drop your file here or click to select a file! &#40;Only .pdf files&#41;</p>
        </label>
        <input className="file-input" name="text" id="file" type="file" onChange={(e) =>{setFile(e.target.files[0])}} accept="application/pdf"/>
    </>
  )
}
